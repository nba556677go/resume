...
\subtext{\textbf{Google} \hfill Kirkland, WA}
\begin{zitemize}
        \item Improved GPU/TPU admission-control reliability via distributed caching, reducing tail latency by \textbf{30\%}.
        \item Built a multithreaded RPC caller that reduced P99 latency by \textbf{10x} and resolved eight critical SLO violations.
\end{zitemize}
