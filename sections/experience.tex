...
\begin{zitemize}
        \item Scaled GPU/TPU admission control for 100x traffic via distributed caching, cutting latency by \textbf{60\%} with a \textbf{90\%} hit rate.
        \item Built a multithreaded RPC client that reduced P99 latency by \textbf{10x}, resolving 8 SLO violations and a SEV-1 incident.
\end{zitemize}
