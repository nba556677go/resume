...
\begin{zitemize}
        ...
        \item Designed a AI workload-aware colocation strategy using fine-grained GPU kernel profiles from \textbf{NVIDIA Nsight Compute}. Reduced total job completion time by 36\%.
\end{zitemize}
\vspace{-2pt}
\begin{zitemize}
